(function(){
  function install(){
    ...
    const canSee=sol=>{
      ...
      // REGRA GLOBAL: Financeiro, Logística e Operações não possuem filtro de unidade.
    ...
    // CORREÇÃO DEFINITIVA: substitui a função que o index.html usa de fato.
    // O index.html chama Render.visibleSolicitacoes() diretamente no dashboard e na lista.
    ...
    // Proteção adicional para chamadas que utilizem Render.solicitacoes diretamente.
